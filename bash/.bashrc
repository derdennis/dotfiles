...
case $platform in
    ...
    # Smart resize function with imagemagick
    # Use it like: smartresize "inputfile.png" "300" "outputdir/"
    # or with multiple files: smartresize "*.jpg" "400" "outputdir/"
    #via: https://www.smashingmagazine.com/2015/06/efficient-image-resizing-with-imagemagick/
